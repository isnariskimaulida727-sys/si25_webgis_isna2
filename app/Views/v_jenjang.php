        ...
        <tbody>
          ...
          foreach ($jenjang as $key => $value) { ?>
            <tr>
             ...
             <td class="text-center"><img src="<?= base_url('marker/'.$value['marker'])?>" width="40px"></td>
              <td class="text-center">
                <button data-toggle="modal" data-target="#edit<?= $value['id_jenjang'] ?>" class="btn btn-sm btn-warning btn-flate"><i class="fas fa-map-marker-alt"></i>Ganti Marker</button>
